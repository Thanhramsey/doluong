...
class Code extends CI_Controller {
    ...
    public static $namecontroller = "Code";
    public static $title = "Quy định";
    ...
    public function create(){
        if (!$this->session->userdata('login')) {
            ...
            if($this->model->checkpermission($this::$permission,$login)==true){
                ...
                $data['controllername'] = $this::$namecontroller;
                $this->form_validation->set_rules('chiso', 'Tên', 'trim|required');
                $this->form_validation->set_rules('qc', 'Quyết định', 'trim|required');
