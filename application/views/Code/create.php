                ...
                <form role="form" method="post" action="<?php echo base_url($controllername.'/create'); ?>" enctype="multipart/form-data">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInputUsername" name="qc" placeholder="Nhập tên QC" value="<?php echo set_value('ten'); ?>">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputUsername">Chỉ số<span style="color:#EA3838">(*)<?php echo form_error('chiso'); ?></span></label>
                            <input type="text" class="form-control" id="exampleInputUsername" name="chiso" placeholder="Nhập tên QC" value="">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label>Năng lực thử nghiệm</label>
                            <select id="method" name="method" class="form-control select2" style="width: 100%;">
